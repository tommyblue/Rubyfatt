...
* Collegati all'applicazione dall'indirizzo http://localhost:3000/ e fai login con i dati di _db_seeds.rb_ (quelli di default sono _email "demo@example.com"_ e _password "password"_)
